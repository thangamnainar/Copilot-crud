...
export declare class DynamicDialogComponent implements AfterViewInit, OnDestroy {
    ...
    get position(): string;
    set style(value: any);
    constructor(document: Document, componentFactoryResolver: ComponentFactoryResolver, cd: ChangeDetectorRef, renderer: Renderer2, config: DynamicDialogConfig, dialogRef: DynamicDialogRef, zone: NgZone, primeNGConfig: PrimeNGConfig, parentDialog: DynamicDialogComponent);
